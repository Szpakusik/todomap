...
export class myInit1616405758424 implements MigrationInterface {
    name = 'myInit1616405758424'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "todo_list" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, CONSTRAINT "PK_1a5448d48035763b9dbab86555b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "todo" ("id" SERIAL NOT NULL, "body" character varying NOT NULL, "eisenhoverQuarter" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "modifiedAt" TIMESTAMP NOT NULL DEFAULT now(), "parentListId" integer, "childListId" integer, CONSTRAINT "REL_3078f1834c6d13813a8385eb6f" UNIQUE ("childListId"), CONSTRAINT "PK_d429b7114371f6a35c5cb4776a7" PRIMARY KEY ("id"))`);
